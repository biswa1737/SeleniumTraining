...
public class TC3 extends Reporter {
	...
	//Testcase 3 -Validate KSS type field 
		...
		public void setup() throws Throwable {
			...
			extest= extent.startTest("Testcase 3: Validate KSS type field on screen"); //name your test				
		...
		public void test2() throws InterruptedException{
			...
			//extest= extent.startTest("Testcase 2: Validate fields on screen "); //name your test
				...
				System.out.println(KSSTypeDropList.getText());
				
				if (KSSTypeDropList.getText().equals(prop.getProperty("drop1val"))){
