...
public class TC4 extends Reporter {
	...
	//Testcase 4 - Validate topic field 
	...
	public void setup() throws Throwable {
		...
		extest= extent.startTest("Testcase 4: Validate Topic field on screen"); //name your test				
	...
	public void test2() throws InterruptedException{
		...
		//extest= extent.startTest("Testcase 2: Validate fields on screen "); //name your test
			...
			if (topicEditfield.isDisplayed() && topicEditfield.isEnabled()){
				extest.log(LogStatus.INFO,"Topic field is displayed and enabled");
				topicEditfield.sendKeys("Testing Topic field");
				extest.log(LogStatus.INFO,"Topic field can accept value ");
				extest.log(LogStatus.PASS,"Testcase Passed");
			}else{
				extest.log(LogStatus.INFO,"Topic field is not displayed and disabled");
